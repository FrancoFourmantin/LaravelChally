...
@section('email_usuario' , $participante->email)
@section('main')
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <tr>
              ...
              ><strong>{{$participante->nombre}}</strong>, el desafio <strong>{{$desafio->titulo}}</strong> ya finalizo! Es hora de saber quien sera el ganador</div>
            ...
            <tbody>
              <tr>
                <td  style="width:500px;">
                  ...
                  <img
                  height="auto" src="http://localhost:8000/img/emails/cup-woman.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="500"
                  />
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <tr>
                  ...
                  >Tienes <strong style="color:red">48hs</strong> desde la finalización del desafio para elegir tu respuesta ganadora</div>
