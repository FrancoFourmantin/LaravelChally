      ...
      <tr>
        ...
        <![endif]-->
              ...
              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                <tr>
                  <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:28px;text-align:center;color:#1bb76e;">Tu respuesta al desafío {{$desafio->nombre}} fue enviada correctamente</div>
                  </td>
                </tr>
                <tr>
            ...
            Ver tu respuesta
                ...
                <tr>
                  <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:center;color:#aaaaaa;">Recordá que tenés tiempo hasta el {{$desafio->fecha_limite}} para editar tu respuesta si lo necesitás.</div>
                  </td>
                </tr>
              </table>
            </div>
